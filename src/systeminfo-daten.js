...
export const SI_DIENSTE = [
  ...
  { gruppe: 'Karten & Geodaten', items: [
    ...
    { name: 'OpenRouteService (Routing)', zweck: 'Berechnung der Tour-Fahrstrecken (Desktop) sowie Routenlinie und Navigation in der Fahrer-App', lizenz: 'Dienst von HeiGIT; Daten OSM/ODbL', frei: 'Kostenloser Plan mit Tageslimit (ca. 2.000 Routen/Tag, 500 Matrix/Tag)', status: 'achtung', hinweis: 'Je Stadt eigener API-Schlüssel. Die Navigation (Turn-by-turn, Neuberechnungen) erhöht das Anfragevolumen deutlich — bei breitem Einsatz kostenpflichtiger Plan oder eigener ORS/OSRM-Server nötig. Der frühere öffentliche OSRM-Demo-Server wird nicht mehr genutzt.' },
    ...
    { name: 'OpenStreetMap / Overpass (Straßennetz-Import)', zweck: 'Einmalige Extraktion des Straßennetzes als Linien-Objekte für die Straßenabschnitts-Planung (Skript scripts/import-osm-ahlen.mjs)', lizenz: 'Daten ODbL (© OpenStreetMap-Mitwirkende)', frei: 'Ja, mit Namensnennung; Overpass nur sparsam (kein Massen-Polling)', status: 'achtung', hinweis: 'Reiner Offline-/Einmal-Import (kein Live-Dienst in den Apps). ODbL verlangt Namensnennung „© OpenStreetMap-Mitwirkende" und ggf. Share-alike bei abgeleiteten Daten — vor produktivem Rollout prüfen. Wo die Stadt eigene amtliche Straßen(-reinigungs)-Daten hat, sind diese vorzuziehen.' },
  ]},
