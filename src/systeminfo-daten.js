...
export const SI_DIENSTE = [
  { gruppe: 'Programmbibliotheken (im Browser)', items: [
    ...
    { name: 'Chart.js (lokal ausgeliefert)', zweck: 'Diagramme (Controlling, Einsatzleiter)', lizenz: 'MIT (Open Source)', frei: 'Ja, dauerhaft – auch kommerziell', status: 'ok', hinweis: 'Frei nutzbar, keine Auflagen. Seit 21.07.2026 lokal unter /vendor/lib (kein CDN-Nachladen mehr).' },
    { name: 'SheetJS (Community, lokal ausgeliefert)', zweck: 'Excel-Import', lizenz: 'Apache-2.0 (Open Source)', frei: 'Ja – Community-Edition kommerziell frei', status: 'ok', hinweis: 'Die genutzte Community-Edition ist frei; nur die optionale „Pro"-Variante kostet. Seit 21.07.2026 lokal unter /vendor/lib.' },
    { name: 'html-to-image (lokal ausgeliefert)', zweck: 'Karten-/Berichts-Ausdruck (Rasterung)', lizenz: 'MIT (Open Source)', frei: 'Ja, dauerhaft – auch kommerziell', status: 'ok', hinweis: 'Seit 21.07.2026 lokal unter /vendor/lib (kein CDN-Nachladen mehr).' },
    { name: 'proj4js (lokal ausgeliefert)', zweck: 'Koordinaten-Umrechnung bei Import und Shapefile-Export (Gauß-Krüger/UTM ↔ WGS84)', lizenz: 'MIT (Open Source)', frei: 'Ja, dauerhaft – auch kommerziell', status: 'ok', hinweis: 'Reine Rechen-Bibliothek im Browser, keine externen Aufrufe/Datenübertragung. Seit 21.07.2026 lokal unter /vendor/lib. Beim Excel-Import: alte Katasterkoordinaten (Gauß-Krüger, EPSG:31466/67) → WGS84. Beim Shapefile-Export: WGS84 → ETRS89/UTM 32N (EPSG:25832).' },
