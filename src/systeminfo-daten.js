...
export const SI_DIENSTE = [
  ...
  { gruppe: 'Karten & Geodaten', items: [
    ...
    { name: 'Amtliche Luftbilder/WMS (z. B. RLP DOP20)', zweck: 'Luftbild je Projekt (z. B. Ludwigshafen) — ersetzt „Satellit"', lizenz: 'Datenlizenz Deutschland – Namensnennung 2.0 (dl-de/by-2-0)', frei: 'Ja – auch kommerziell, mit Quellenangabe', status: 'ok', hinweis: 'Amtliche Geobasisdaten sind die rechtlich sauberste Luftbildquelle. Quellenangabe ist hinterlegt. Je Stadt den passenden Landesdienst eintragen (NRW/Hessen/Niedersachsen analog).' },
