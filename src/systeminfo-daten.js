...
export const SI_DIENSTE = [
  ...
  { gruppe: 'Plattform & Sicherheit', items: [
    ...
    { name: 'Google reCAPTCHA v3 (App Check)', zweck: 'Schutz vor fremden Clients', lizenz: 'Google-Nutzungsbedingungen', frei: 'Kostenfreies Kontingent — Umfang vor Produktivbetrieb prüfen (siehe Nachweis)', status: 'achtung', nachweis: 'https://docs.cloud.google.com/recaptcha/docs/billing-information', hinweis: 'Läuft unsichtbar zur Missbrauchsabwehr (in Firebase App Check) und übermittelt technische Geräte-/Nutzungssignale an Google, nicht zu Werbezwecken — in der Datenschutzerklärung (Ziffer 4) erwähnt. ACHTUNG: Google hat die reCAPTCHA-Preise zum 01.04.2024 geändert. Für reCAPTCHA Enterprise sind seither nur noch ca. 10.000 Prüfungen/Monat kostenfrei (früher 1 Mio). Welches Kontingent für den in App Check genutzten reCAPTCHA-v3-Anbieter gilt, vor breitem Produktivbetrieb im Nachweis-Link prüfen.' },
  ]},
