...
export const SI_DIENSTE = [
  { gruppe: 'Programmbibliotheken (im Browser)', items: [
    ...
    { name: 'proj4js', zweck: 'Koordinaten-Umrechnung beim Import (Gauß-Krüger/UTM → WGS84)', lizenz: 'MIT (Open Source)', frei: 'Ja, dauerhaft – auch kommerziell', status: 'ok', hinweis: 'Reine Rechen-Bibliothek im Browser, keine externen Aufrufe/Datenübertragung. Wird beim Excel-Import genutzt, um z. B. alte NRW-Katasterkoordinaten (Gauß-Krüger Zone 2/3, EPSG:31466/67) korrekt nach WGS84 zu wandeln.' },
